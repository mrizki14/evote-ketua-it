<nav class="navbar navbar-inverse">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="#"><img class="logo-it" src="<?php echo base_url(); ?>asset/img/favicon.png" alt="it_club" style="height: auto;  width: 50px; bottom: 8px; position: relative;"><b>ITCLUB-VOTING</b></a>
        </div>
    </div>
</nav>
    ...
    <div class="ch-container">
        <div class="row col-md-4 center" style="background-color: white; border-radius: 20px; padding:20px;">
            <div class="row-md-5 center login-box">
                <h2 style="color: crimson; margin-bottom: 28px;"><b style="line-height: 45px;">LOGIN <br>ITCLUB-VOTING</b></h2>
        ...
        <footer style="position: fixed; left: 0; bottom: 0; width: 100%; background-color: #03325d;  color: white;  text-align: center; padding:5px;">
            <p style="padding-top:10px; text-align:center;"><b>2023&copy; ITCLUB-VOTING</b></p>
        </footer>
    </div>