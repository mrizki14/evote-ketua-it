	...
	<div class="box">
		<div class="box-inner">
			<div class="box-header" style="height:80px; padding:13px;">
				<p>DAFTAR CALON KETUA & WAKIL IT<br>SMKN 5 BANDUNG</p>
			</div>
				...
				<div class="row">
					...
					?>
						<div class="col-lg-4">
							<div class="box">
								<div class="box-inner">
									<div class="box-header well text-center" style="display: flex; justify-content: center;">
										<h2 class="text-center bold" style="color:#555555; text-align:center; font-size:30px;"><?php echo $loaddata['no']; ?> - <?php echo $loaddata['nama']; ?> </h2>
									</div>
									<div class="box-content">
